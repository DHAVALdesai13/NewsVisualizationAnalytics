...
d3.select("#startYear").on("change", function(d) {
    ...
    console.log("year",startYear,endYear)
    dhav.update(selectedOption,startYear, endYear)
    //annie.change(startYear, endYear)
  })
...
d3.csv("./js/d3/data/bardata.csv", function(d, i, columns) {
...
d3v3.tsv("./js/d3/data/timedata.tsv", function(error, data) { 
...
d3v3.csv("./js/d3/data/TeamData.csv", function(d) {
temp = [];
...
function(error, rows){
 //console.log(rows); 
    ...
    var data = rows.filter(function(d){return d.name=="San Francisco 49ers"});
